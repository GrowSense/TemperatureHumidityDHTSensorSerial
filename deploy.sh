...
#  sshpass -p $GARDEN_PASSWORD ssh -o StrictHostKeyChecking=no -t $GARDEN_USER@$GARDEN_HOSTNAME "bash -c 'cd /home/$GARDEN_USER/workspace/GrowSense/Index/sketches/monitor/TemperatureHumidityDHTSensorSerial && sh pull-build-and-upload.sh'"
